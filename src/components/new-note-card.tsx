...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleSaveNote(event: FormEvent) {
    ...
    if (content === '') {
      return toast.error('É necessário escrever ou falar algo para criar a nota!')
    }
  ...
  function handleStartRecording() {
    ...
    if (!isSpeechRecognitionAPIAvaiable) {
      toast.info('Infelizmente, o navegador utilizado não suporta a API de gravação. Utilize Chrome, Edge ou Safari.')
      return
    }
